    ...
    <div className="privacy-page container section animate-fadeUp">
      ...
      <div className="privacy-content">
        <div className="intro-card glass">
          ...
          <p>
            At Sovely, we value your trust and are committed to protecting your
            personal data. This Privacy Policy describes how we collect, use,
            disclose, and safeguard your information when you visit or shop on
            our platform.
          </p>
        </div>
        ...
        <div className="privacy-grid">
          <div className="privacy-card glass">
            ...
            <p>
              ...
              information. We also automatically collect browser types, IP
          ...
          <div className="privacy-card glass">
            ...
            <p>
              We implement industry-standard encryption protocols (like SSL/TLS)
              and secure database access systems to guard your personal
              credentials and financial info. We do not store full credit
              card/UPI details on our own servers.
            </p>
          </div>
          ...
          <div className="privacy-card glass">
            ...
            <p>
              We do not sell your personal data. We share details only with
              trusted service partners (shipping carriers, Razorpay payment
              gateway) as necessary to process, pack, ship, and complete your
              orders.
            </p>
          </div>
          ...
          <div className="privacy-card glass">
            ...
            <p>
              ...
              about you, request corrections, or ask for account deletion. You
              can update your marketing preferences and opt-out of newsletter
        ...
        <div className="outro-card glass text-center">
          ...
          <p>
            Have questions or concerns about your data? Reach out directly to
