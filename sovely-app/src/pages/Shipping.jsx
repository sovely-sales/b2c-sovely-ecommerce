    ...
    <div className="shipping-page container section animate-fadeUp">
      ...
      <div className="shipping-content">
        <div className="intro-card glass">
          ...
          <p>
            We offer **FREE shipping** on all orders above **₹499**. For orders under ₹499, a flat shipping charge of **₹50** is applied at checkout. There are no hidden handling fees.
          </p>
        </div>
